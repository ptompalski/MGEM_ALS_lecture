...
## Grid-based {background-image="images/p2.png" background-size="contain" background-repeat="no-repeat"}
...
![](images/watershed.png) Try it yourself! e.g.: ArcMap \> Spatial Analyst \> Hydrology
